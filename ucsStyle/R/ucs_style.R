#' UCS ggplot theme using Gotham (light backgrounds)
#'
#' Sets a UCS house style for light backgrounds and marks session bg = "light" for scale logic.
#' @return A ggplot2 theme object.
#' @export
ucs_style <- function () {
  options(ucs.bg = "light")
  font <- "Gotham"
  ggplot2::theme(
